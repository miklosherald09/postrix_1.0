...
import { StyleSheet, Text, TextInput, View, TouchableHighlight, Modal, Alert } from 'react-native'
import { Icon, Input } from 'react-native-elements'
import RemoteSubmitButton from '../remote/RemoteSubmitButton'
import { connect } from 'react-redux'
import { Field, reduxForm } from 'redux-form'
import formStyles from '../../constants/styles'
import { addItemModalInvisible, getItems, saveItem } from "../../actions/itemActions"
...
const addItemModal = (props) => {
  ...
  const { input, addItemModalvisible, saveItemMsg } = props.items;
        ...
        >
            ...
            <View style={styles.container}>
              <View style={{flex: 1}}>
							...
							<View style={{flex: 1}}>
								<Text>saveItemMsg: {saveItemMsg}</Text>
							</View>
